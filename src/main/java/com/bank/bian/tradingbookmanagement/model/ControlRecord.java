package com.bank.bian.tradingbookmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Trading Book Management Plan".
 *
 ...
 * to its asset type (Trading Book). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Trading Book Management Plan";
